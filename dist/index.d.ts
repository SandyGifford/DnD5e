declare module DnD5e {
    ...
    type SubClassName = "Berserker" | "Lore" | "Life" | "Land" | "Champion" | "Open Hand" | "Devotion" | "Hunter" | "Thief" | "Draconic" | "Fiend" | "Evocation" | string;
    type RaceName = "Dwarf" | "Elf" | "Halfling" | "Human" | "Dragonborn" | "Gnome" | "Half-Elf" | "Half-Orc" | "Tiefling" | string;
    type SubRaceName = "Hill Dwarf" | "High Elf" | "Lightfoot Halfling" | "Mountain Dwarf" | "Wood Elf" | "Dark Elf (Drow)" | string;
    type AbilityScoreName = "STR" | "DEX" | "CON" | "INT" | "WIS" | "CHA";
    type SkillName = "Acrobatics" | "Animal Handling" | "Arcana" | "Athletics" | "Deception" | "History" | "Insight" | "Intimidation" | "Investigation" | "Medicine" | "Nature" | "Perception" | "Performance" | "Persuasion" | "Religion" | "Sleight of Hand" | "Stealth" | "Survival";
    ...
    interface NamedAPIResourceList<NAME extends string> {
        count: number;
        results: NamedAPIResource<NAME>[];
    }
    interface ClassAPIResourceList {
        count: number;
    ...
    function abilityScores(): Promise<NamedAPIResourceList<AbilityScoreName>>;
    function abilityScores(index: number): Promise<AbilityScore>;
    function skills(): Promise<NamedAPIResourceList<SkillName>>;
    function skills(index: number): Promise<Skill>;
    function proficiencies(): Promise<NamedAPIResourceList<ProficiencyName>>;
    function proficiencies(index: number): Promise<Proficiency>;
    function proficiencies(className: ClassName): Promise<Proficiency>;
    function languages(): Promise<NamedAPIResourceList<LanguageName>>;
    function languages(index: number): Promise<Language>;
    function classes(): Promise<NamedAPIResourceList<ClassName>>;
    function classes(index: number): Promise<CharClass>;
    function classes(className: ClassName): Promise<CharClass>;
    function subClasses(): Promise<NamedAPIResourceList<SubClassName>>;
    function subClasses(index: number): Promise<CharSubClass>;
    function subClasses(className: ClassName): Promise<CharSubClass>;
    function features(): Promise<NamedAPIResourceList<FeatureName>>;
    function features(index: number): Promise<Feature>;
    function classLevel(className: ClassName, level: Level): Promise<ClassLevel>;
    function races(): Promise<NamedAPIResourceList<RaceName>>;
    function races(index: number): Promise<Race>;
    function subRaces(): Promise<NamedAPIResourceList<SubRaceName>>;
    function subRaces(index: number): Promise<SubRace>;
    function subRaces(race: RaceName): Promise<SubRace>;
    function traits(): Promise<NamedAPIResourceList<TraitName>>;
    function traits(index: number): Promise<Trait>;
    function equipment(): Promise<NamedAPIResourceList<EquipmentName>>;
    function equipment(index: number): Promise<Equipment>;
    function conditions(): Promise<NamedAPIResourceList<ConditionName>>;
    function conditions(index: number): Promise<Condition>;
    function damageTypes(): Promise<NamedAPIResourceList<DamageTypeName>>;
    function damageTypes(index: number): Promise<DamageType>;
