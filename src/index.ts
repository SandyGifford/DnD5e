module DnD5e {
	...
	export function abilityScores(): Promise<NamedAPIResourceList<AbilityScoreName>>;
	export function abilityScores(index: number): Promise<AbilityScore>;
	export function abilityScores(index?: number): Promise<any> {
		return fetch(`http://www.dnd5eapi.co/api/ability-scores/${typeof index !== "undefined" ? index : ""}`)
			.then(r => r.json());
	}

	export function skills(): Promise<NamedAPIResourceList<SkillName>>;
	export function skills(index: number): Promise<Skill>;
	export function skills(index?: number): Promise<any> {
		return fetch(`http://www.dnd5eapi.co/api/skills/${typeof index !== "undefined" ? index : ""}`)
			.then(r => r.json());
	}

	export function proficiencies(): Promise<NamedAPIResourceList<ProficiencyName>>;
	export function proficiencies(index: number): Promise<Proficiency>;
	export function proficiencies(className: ClassName): Promise<Proficiency>;
	export function proficiencies(indexer?: number | ClassName): Promise<any> {
		return fetch(`http://www.dnd5eapi.co/api/proficiencies/${typeof indexer !== "undefined" ? indexer : ""}`)
			.then(r => r.json());
	}

	export function languages(): Promise<NamedAPIResourceList<LanguageName>>;
	export function languages(index: number): Promise<Language>;
	export function languages(index?: number): Promise<any> {
		return fetch(`http://www.dnd5eapi.co/api/languages/${typeof index !== "undefined" ? index : ""}`)
			.then(r => r.json());
	}

	export function classes(): Promise<NamedAPIResourceList<ClassName>>;
	export function classes(index: number): Promise<CharClass>;
	export function classes(className: ClassName): Promise<CharClass>;
	export function classes(indexer?: number | ClassName): Promise<any> {
		return fetch(`http://www.dnd5eapi.co/api/classes/${typeof indexer !== "undefined" ? indexer : ""}`)
			.then(r => r.json());
	}


	export function subClasses(): Promise<NamedAPIResourceList<SubClassName>>;
	export function subClasses(index: number): Promise<CharSubClass>;
	export function subClasses(className: ClassName): Promise<CharSubClass>;
	export function subClasses(indexer?: number | ClassName): Promise<any> {
		return fetch(`http://www.dnd5eapi.co/api/subclasses/${typeof indexer !== "undefined" ? indexer : ""}`)
			.then(r => r.json());
	}

	export function features(): Promise<NamedAPIResourceList<FeatureName>>;
	export function features(index: number): Promise<Feature>;
	export function features(index?: number): Promise<any> {
		return fetch(`http://www.dnd5eapi.co/api/features/${typeof index !== "undefined" ? index : ""}`)
			.then(r => r.json());
	}

	export function classLevel(className: ClassName, level: Level): Promise<ClassLevel> {
		return fetch(`http://www.dnd5eapi.co/api/classes/${className}/level/${level}`)
			.then(r => r.json());
	}

	export function races(): Promise<NamedAPIResourceList<RaceName>>;
	export function races(index: number): Promise<Race>;
	export function races(index?: number): Promise<any> {
		return fetch(`http://www.dnd5eapi.co/api/races/${typeof index !== "undefined" ? index : ""}`)
			.then(r => r.json());
	}

	export function subRaces(): Promise<NamedAPIResourceList<SubRaceName>>;
	export function subRaces(index: number): Promise<SubRace>;
	export function subRaces(race: RaceName): Promise<SubRace>;
	export function subRaces(indexer?: any): Promise<any> {
		return fetch(`http://www.dnd5eapi.co/api/subraces/${typeof indexer !== "undefined" ? indexer : ""}`)
			.then(r => r.json());
	}

	export function traits(): Promise<NamedAPIResourceList<TraitName>>;
	export function traits(index: number): Promise<Trait>;
	export function traits(index?: number): Promise<any> {
		return fetch(`http://www.dnd5eapi.co/api/traits/${typeof index !== "undefined" ? index : ""}`)
			.then(r => r.json());
	}

	export function equipment(): Promise<NamedAPIResourceList<EquipmentName>>;
	export function equipment(index: number): Promise<Equipment>;
	export function equipment(index?: number): Promise<any> {
		return fetch(`http://www.dnd5eapi.co/api/equipment/${typeof index !== "undefined" ? index : ""}`)
			.then(r => r.json());
	}

	export function conditions(): Promise<NamedAPIResourceList<ConditionName>>;
	export function conditions(index: number): Promise<Condition>;
	export function conditions(index?: number): Promise<any> {
		return fetch(`http://www.dnd5eapi.co/api/conditions/${typeof index !== "undefined" ? index : ""}`)
			.then(r => r.json());
	}

	export function damageTypes(): Promise<NamedAPIResourceList<DamageTypeName>>;
	export function damageTypes(index: number): Promise<DamageType>;
	export function damageTypes(index?: number): Promise<any> {
		return fetch(`http://www.dnd5eapi.co/api/damage-types/${typeof index !== "undefined" ? index : ""}`)
			.then(r => r.json());
	}

	export function magicSchools(): Promise<NamedAPIResourceList<MagicSchoolName>>;
	export function magicSchools(index: number): Promise<MagicSchool>;
	export function magicSchools(index?: number): Promise<any> {
